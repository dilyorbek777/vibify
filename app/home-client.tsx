    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 relative">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 space-y-8 md:space-y-12 z-100 pb-20 md:pb-24">
            ...
            {isSearching ? (
              ...
              <>
                ...
                {searchResults.filter(r => r.type === 'artist').length > 0 && (
                  <div className="mb-8">
                    <h3 className="text-lg font-semibold mb-4 font-sans">Artists</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                      {searchResults
                ...
                {searchResults.filter(r => r.type === 'song').length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-4 font-sans">Songs</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                      {searchResults
                        .filter(r => r.type === 'song')
                        .map((result) => {
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold tracking-tight font-sans">Your Playlists</h2>
                ...
                >
                  <div className={`aspect-square overflow-hidden  w-full relative bg-background/80 border-primary border-2 rounded-full flex items-center justify-center text-5xl relative shadow-md ${isPlaylistPlaying(playlist) ? 'animate-spin ' : ''}`} style={isPlaylistPlaying(playlist) ? { animationDuration: '3s' } : undefined}>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-black/60 rounded-b-full backdrop-blur-sm p-2 text-center">
                      <CardTitle className="text-sm font-bold tracking-tight line-clamp-1 font-sans text-white">{playlist.name}</CardTitle>
              ...
              >
                <div className={`aspect-square w-full bg-background/80 border-primary border-2 rounded-full flex items-center justify-center text-5xl relative shadow-md `}>
                  ...
                  <div className="space-y-1.5 px-1">
                    <CardTitle className="text-base font-bold tracking-tight line-clamp-1 font-sans">See all</CardTitle>
        ...
        <section>
          <div className="flex items-center justify-between z-10 relative mb-6">
            <div>
              <h2 className="text-2xl font-bold tracking-tight font-sans">Your Favorites</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              ...
              <div className="space-y-1.5 px-1">
                <CardTitle className="text-base font-bold tracking-tight line-clamp-1 font-sans">Play your favorite songs</CardTitle>
                <CardDescription className="text-xs text-muted-foreground line-clamp-2 leading-relaxed">
            ...
            {[...likedSongs].reverse().slice(-3).map(playlist => (
              ...
              >
                ...
                <div className="space-y-1.5 px-1">
                  <CardTitle className="text-base font-bold tracking-tight line-clamp-1 font-sans">{playlist.name}</CardTitle>
                  <CardDescription className="text-xs text-muted-foreground line-clamp-2 leading-relaxed">
                    {playlist.description} <span className="text-primary flex items-center justify-start gap-2"><UserStar size={18} /> {playlist.artist}</span>
                  </CardDescription>
                </div>
        ...
        {recentlyPlayed.length > 0 && (
          <section className='z-10'>
            <h2 className="text-2xl font-bold tracking-tight mb-6 font-sans">Recently Played</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
        ...
        <section className='pb-18 z-10 relative'>
          <div className="flex items-center gap-2 mb-6 ">
            ...
            <h2 className="text-2xl font-bold tracking-tight font-sans">Explore Genres</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-3">
            {['Pop', 'Rock', 'Hip-Hop', 'Electronic', 'R&B', 'Jazz', 'Classical', 'Country'].map((genre) => (
              ...
              >
                ...
                >
                  <span className="text-xs font-semibold tracking-wide font-sans">{genre}</span>
                </Button>
              </Link>
            ))}
